...
**@dexploarer/plugin-vercel-ai-gateway** is an ElizaOS plugin providing unified AI model access through Vercel AI Gateway, OpenRouter, and direct Vercel AI SDK integration. It supports 200+ models across all major providers (OpenAI, Anthropic, Google, Meta, Mistral, xAI, etc.) via a single API key.
